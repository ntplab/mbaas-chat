...
int mbserver::del_message(void* req, char** out, size_t* outlen, MB_PLACEHOLDER placeholder, std::string body, size_t bodylen){
    ...
    if (!db->remove_message(gid, uid, mid, &lastid)){
        return(401);
    }
